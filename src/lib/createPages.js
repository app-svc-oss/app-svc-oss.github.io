...
exports.createPages = function (_a) {
    var graphql = _a.graphql, boundActionCreators = _a.boundActionCreators;
    return __awaiter(void 0, void 0, void 0, function () {
        var createPage, allMarkdown, posts;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    posts = allMarkdown.data.allMarkdownRemark.edges;
                    posts.forEach(function (post, index) {
                        ...
                        createPage({
                            ...
                            component: path_1["default"].resolve("./src/templates/blog-post.tsx"),
                            context: {
                                next: next,
                                previous: previous,
